...
class BestFitDynamicPartitioning
{
    ...
    int addToList(int p,int sp)
    {
        ...
        {
        	s1 = iter.next();
        	if(s1.flag == 0 && s1.finish - s1.start + 1 >= sp && s1.finish - s1.start + 1 < min)
        	{
        		
        		min = s1.finish -s1.start + 1;
    ...
    {
        BestFitDynamicPartitioning dp = new BestFitDynamicPartitioning();
        dp.addToList(1,8);
        dp.addToList(2,30);
        dp.addToList(3,12);
        dp.addToList(4,10);
